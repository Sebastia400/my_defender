...
sfSprite *create_soldier_4_d_d(void)
{
    ...
    ("./images/game/soldiers/black/soldier_diagonal_down.png", NULL);
...
{
    sfTexture *texture_bend = sfTexture_createFromFile
    ("./images/game/soldiers/black/soldier_diagonal_up.png", NULL);
    sfSprite *sprite_bend = sfSprite_create();
    sfSprite_setTexture(sprite_bend, texture_bend, 0);
    return (sprite_bend);
}
...
{
    sfTexture *texture_bend = sfTexture_createFromFile
    ("./images/game/soldiers/black/soldier_going_up.png", NULL);
    sfSprite *sprite_bend = sfSprite_create();
    sfSprite_setTexture(sprite_bend, texture_bend, 0);
    return (sprite_bend);
}
...
{
    sfTexture *texture_bend = sfTexture_createFromFile
    ("./images/game/soldiers/black/soldier_running.png", NULL);
    sfSprite *sprite_bend = sfSprite_create();
    sfSprite_setTexture(sprite_bend, texture_bend, 0);
    return (sprite_bend);
}
...
{
    sfTexture *texture_bend = sfTexture_createFromFile
    ("./images/game/soldiers/black/soldier_running_2.png", NULL);
    sfSprite *sprite_bend = sfSprite_create();
    sfSprite_setTexture(sprite_bend, texture_bend, 0);
    return (sprite_bend);
}
